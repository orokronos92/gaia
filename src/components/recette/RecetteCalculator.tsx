...
export const RecetteCalculator = forwardRef<RecetteCalculatorHandle, RecetteCalculatorProps>(
  ...
  const persister = async (): Promise<{ saved: boolean; reason?: string }> => {
    ...
    // La liste déclarée n'est plus touchée : les dénominations imprimées se
    // règlent sur la carte « recette étiquette » de la fiche produit, ligne par
    // ligne (décision 2026-09-10).
    return { saved: true };
  };
