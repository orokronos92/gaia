 ...
 * strings/codes the regulation (PRO-QHS-313) requires verbatim on every JDG
...
/** PRO-QHS-313 §5 — mandatory conservation mention. */
export const MENTION_CONSERVATION_JDG =
  "À conserver à l'abri de l'humidité, de la lumière et de la chaleur";

/** PRO-QHS-313 §7 — manufacturer address. Matched by its invariant tokens. */
...
/** PRO-QHS-313 §11.1 — control-body code of the last operator (Ecocert France). */
export const CODE_OC_ATTENDU = "FR-BIO-01";
export const CODE_OC_PATTERN = /\bFR-BIO-\d{2}\b/i;

/** PRO-QHS-313 §3.3 — licorice (réglisse) detection keywords (designation scan). */
export const REGLISSE_KEYWORDS = ["reglisse", "glycyrrhiza"] as const;

/** PRO-QHS-313 §3.3 — invariant tokens of the JDG hypertension mention. */
...
/** PRO-QHS-313 §4 — net-quantity mass units. */
