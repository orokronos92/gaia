 ...
 * silent PASS).
 *
 * Deux points voisins vivent ailleurs, et pour la même raison : ils se
 * répondent sur le BAT, pas sur la fiche. Le préfixe « Ingrédients : » (2.1)
 * est une décoration d'étiquette, et la correspondance entre la recette
 * étiquette et la liste imprimée (2.5) demande de lire ce qui est imprimé —
 * aucun code ne peut deviner depuis la fiche seule que « SORWATHE OP1 » n'est
 * pas une dénomination légale alors que « THYM » en est une.
 */
