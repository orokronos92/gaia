...
> Base : commit `fd0e379` · généré le 2026-09-23

**257 fichiers · 33427 lignes** (src/, scripts/, drizzle/ — hors tests et fichiers de déclaration)
...
|---|---:|---:|---|---|
| `scripts` | 9 | 906 | `scripts/architecture`, `src/agents/imports`, `src/db`, `src/db/queries`, `src/lib/audit`, `src/lib/conditionnement`, `src/lib/import-catalogue`, `src/lib/utils` | — |
...
| `src/db` | 5 | 1052 | — | `scripts`, `src`, `src/agents/audit`, `src/agents/imports`, `src/agents/knowledge`, `src/app/(dashboard)`, `src/app/actions`, `src/app/api`, `src/db/queries` |
...
| `src/lib/import-catalogue` | 13 | 1290 | — | `scripts`, `src/db/queries` |
